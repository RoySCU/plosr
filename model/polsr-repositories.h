...
///
/// \brief Here are defined all data structures needed by an POLSR node.
///

#ifndef POLSR_REPOSITORIES_H
#define POLSR_REPOSITORIES_H
...
/// A Link Tuple.
                ...
                static inline bool
                operator == (const PositionTuple &a, const PositionTuple &b)
                {
                  return (a.gps_x == b.gps_x
                          && a.gps_y == b.gps_y
                          && a.speed_x == b.speed_x
                          && a.speed_y == b.speed_y);
                }
                static inline std::ostream&
                operator << (std::ostream &os, const PositionTuple &tuple)
                {
                  os<< "(" << "pos x=" << tuple.gps_x << " y=" << tuple.gps_y
                  << ", speed x=" << (int) tuple.speed_x << " y=" << (int) tuple.speed_y <<  ")";
                  return os;
                }
/// A Neighbor Tuple.
                ...
                operator << (std::ostream &os, const NeighborTuple &tuple)
                {
                  ...
                  << ", willingness=" << (int) tuple.willingness << tuple.neighborPosition  << ")";
                  return os;
                }
...
/// An Association Tuple
                ...
                typedef std::vector<PositionTuple>              PositionSet; ///< Position Set type.
                
                }} // namespace ns3, polsr

#endif /* POLSR_REPOSITORIES_H */
