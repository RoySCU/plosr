...
MprSelectorTuple*
POlsrState::FindMprSelectorTuple (Ipv4Address const &mainAddr)
{
...
void
POlsrState::EraseMprSelectorTuple (const MprSelectorTuple &tuple)
{
  for (MprSelectorSet::iterator it = m_mprSelectorSet.begin ();
       it != m_mprSelectorSet.end (); it++)
    {
...
void
POlsrState::EraseMprSelectorTuples (const Ipv4Address &mainAddr)
{
  for (MprSelectorSet::iterator it = m_mprSelectorSet.begin ();
...
void
POlsrState::InsertMprSelectorTuple (MprSelectorTuple const &tuple)
{
  m_mprSelectorSet.push_back (tuple);
}

std::string
POlsrState::PrintMprSelectorSet () const
{
...
NeighborTuple*
POlsrState::FindNeighborTuple (Ipv4Address const &mainAddr)
{
...
const NeighborTuple*
POlsrState::FindSymNeighborTuple (Ipv4Address const &mainAddr) const
{
...
NeighborTuple*
POlsrState::FindNeighborTuple (Ipv4Address const &mainAddr, uint8_t willingness)
{
  for (NeighborSet::iterator it = m_neighborSet.begin ();
       it != m_neighborSet.end (); it++)
    {
...
void
POlsrState::EraseNeighborTuple (const NeighborTuple &tuple)
{
  for (NeighborSet::iterator it = m_neighborSet.begin ();
       it != m_neighborSet.end (); it++)
    {
...
void
POlsrState::EraseNeighborTuple (const Ipv4Address &mainAddr)
{
  for (NeighborSet::iterator it = m_neighborSet.begin ();
       it != m_neighborSet.end (); it++)
    {
...
void
POlsrState::InsertNeighborTuple (NeighborTuple const &tuple)
{
  for (NeighborSet::iterator it = m_neighborSet.begin ();
       it != m_neighborSet.end (); it++)
    {
...
TwoHopNeighborTuple*
POlsrState::FindTwoHopNeighborTuple (Ipv4Address const &neighborMainAddr,
...
void
POlsrState::EraseTwoHopNeighborTuple (const TwoHopNeighborTuple &tuple)
{
  for (TwoHopNeighborSet::iterator it = m_twoHopNeighborSet.begin ();
       it != m_twoHopNeighborSet.end (); it++)
    {
...
void
POlsrState::EraseTwoHopNeighborTuples (const Ipv4Address &neighborMainAddr,
...
void
POlsrState::InsertTwoHopNeighborTuple (TwoHopNeighborTuple const &tuple)
{
...
bool
POlsrState::FindMprAddress (Ipv4Address const &addr)
{
...
void
POlsrState::SetMprSet (MprSet mprSet)
{
  m_mprSet = mprSet;
}
MprSet
POlsrState::GetMprSet () const
{
  return m_mprSet;
}
...
DuplicateTuple*
POlsrState::FindDuplicateTuple (Ipv4Address const &addr, uint16_t sequenceNumber)
{
...
void
POlsrState::EraseDuplicateTuple (const DuplicateTuple &tuple)
{
  for (DuplicateSet::iterator it = m_duplicateSet.begin ();
       it != m_duplicateSet.end (); it++)
    {
...
void
POlsrState::InsertDuplicateTuple (DuplicateTuple const &tuple)
{
...
LinkTuple*
POlsrState::FindLinkTuple (Ipv4Address const & ifaceAddr)
{
...
LinkTuple*
POlsrState::FindSymLinkTuple (Ipv4Address const &ifaceAddr, Time now)
{
  for (LinkSet::iterator it = m_linkSet.begin ();
       it != m_linkSet.end (); it++)
    {
...
void
POlsrState::EraseLinkTuple (const LinkTuple &tuple)
{
  for (LinkSet::iterator it = m_linkSet.begin ();
       it != m_linkSet.end (); it++)
    {
...
LinkTuple&
POlsrState::InsertLinkTuple (LinkTuple const &tuple)
{
...
TopologyTuple*
POlsrState::FindTopologyTuple (Ipv4Address const &destAddr,
...
TopologyTuple*
POlsrState::FindNewerTopologyTuple (Ipv4Address const & lastAddr, uint16_t ansn)
{
  for (TopologySet::iterator it = m_topologySet.begin ();
       it != m_topologySet.end (); it++)
    {
...
void
POlsrState::EraseTopologyTuple (const TopologyTuple &tuple)
{
  for (TopologySet::iterator it = m_topologySet.begin ();
       it != m_topologySet.end (); it++)
    {
...
void
POlsrState::EraseOlderTopologyTuples (const Ipv4Address &lastAddr, uint16_t ansn)
{
  for (TopologySet::iterator it = m_topologySet.begin ();
...
void
POlsrState::InsertTopologyTuple (TopologyTuple const &tuple)
{
...
IfaceAssocTuple*
POlsrState::FindIfaceAssocTuple (Ipv4Address const &ifaceAddr)
{
...
POlsrState::FindIfaceAssocTuple (Ipv4Address const &ifaceAddr) const
{
...
void
POlsrState::EraseIfaceAssocTuple (const IfaceAssocTuple &tuple)
{
  for (IfaceAssocSet::iterator it = m_ifaceAssocSet.begin ();
       it != m_ifaceAssocSet.end (); it++)
    {
...
void
POlsrState::InsertIfaceAssocTuple (const IfaceAssocTuple &tuple)
{
  m_ifaceAssocSet.push_back (tuple);
}

std::vector<Ipv4Address>
POlsrState::FindNeighborInterfaces (const Ipv4Address &neighborMainAddr) const
{
...
AssociationTuple*
POlsrState::FindAssociationTuple (const Ipv4Address &gatewayAddr, const Ipv4Address &networkAddr, const Ipv4Mask &netmask)
{
...
void
POlsrState::EraseAssociationTuple (const AssociationTuple &tuple)
{
  for (AssociationSet::iterator it = m_associationSet.begin ();
       it != m_associationSet.end (); it++)
    {
...
void
POlsrState::InsertAssociationTuple (const AssociationTuple &tuple)
{
  m_associationSet.push_back (tuple);
}

void
POlsrState::EraseAssociation (const Association &tuple)
{
...
void
POlsrState::InsertAssociation (const Association &tuple)
{
